...
function whatHide(){
	...
	document.getElementById("arrow1").setAttribute("id" , "arrow-rotate1");
	document.getElementById("arrow-rotate2").setAttribute("id" , "arrow2");
	document.getElementById("arrow-rotate3").setAttribute("id" , "arrow3");
	document.getElementById("arrow-rotate4").setAttribute("id" , "arrow4");*/
		/*document.getElementById("arrow-rotate2").style.color="hsl(231, 69%, 60%)";
		document.getElementById("arrow-rotate3").style.color="hsl(231, 69%, 60%)";
		document.getElementById("arrow-rotate4").style.color="hsl(231, 69%, 60%)";*/
	...
	/*	turn = !turn;
		...
		document.querySelector(".paragraph1").style.display="none";
		document.getElementById("arrow-rotate1").setAttribute("id" , "arrow1");
...
/*	document.querySelector(".paragraph2").style.display="block";
	...
	document.getElementById("arrow2").setAttribute("id" , "arrow-rotate2");
	document.getElementById("arrow-rotate1").setAttribute("id" , "arrow1");
	document.getElementById("arrow-rotate3").setAttribute("id" , "arrow3");
	document.getElementById("arrow-rotate4").setAttribute("id" , "arrow4");*/
	/*document.getElementById("arrow-rotate1").style.color="hsl(231, 69%, 60%)";
		document.getElementById("arrow-rotate3").style.color="hsl(231, 69%, 60%)";
		document.getElementById("arrow-rotate4").style.color="hsl(231, 69%, 60%)";*/
...
function isHide(){
	...
	document.getElementById("arrow3").setAttribute("id" , "arrow-rotate3");
	document.getElementById("arrow-rotate1").setAttribute("id" , "arrow1");
	document.getElementById("arrow-rotate2").setAttribute("id" , "arrow2");
	document.getElementById("arrow-rotate4").setAttribute("id" , "arrow4");*/
	/*	document.getElementById("arrow-rotate2").style.color="hsl(231, 69%, 60%)";
...
function aboutHide(){
	...
	//if(document.querySelector(".paragraph1").style.display==="none"){ 
	...
	document.getElementById("arrow4").setAttribute("id" , "arrow-rotate4");
	//document.getElementById("arrow-rotate1").setAttribute("id" , "arrow1");
	document.getElementById("arrow-rotate2").setAttribute("id" , "arrow2");
	document.getElementById("arrow-rotate3").setAttribute("id" , "arrow3");*/
	
	/*document.getElementById("arrow1").setAttribute("id" , "arrrow1");
	document.getElementById("arrow2").setAttribute("id" , "arrrow2");
	document.getElementById("arrow3").setAttribute("id" , "arrrow3");*/
	/*	document.getElementById("arrow-rotate2").style.color="hsl(231, 69%, 60%)";
		document.getElementById("arrow-rotate3").style.color="hsl(231, 69%, 60%)";
		document.getElementById("arrow-rotate1").style.color="hsl(231, 69%, 60%)";*/
	 ...
	 else if(document.querySelector(".paragraph1").style.display==="block") {
		document.getElementById("arrow-rotate4").setAttribute("id" , "arrow4");
